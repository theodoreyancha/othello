...
def draw(screen, images, chessboard):
    ...
    fontObj = pygame.font.Font('assets/japan.ttf', images.width)
    ...
    # draw text
    textSurfaceObj = fontObj.render("Press 'z' to undo", True, (0, 0, 0))
    textRectObj = textSurfaceObj.get_rect()
    textRectObj.center = (pos + 100, pos - 450) #pos + 100, pos -150
    screen.blit(textSurfaceObj, textRectObj)

    textSurfaceObj = fontObj.render("Press 'Esc' to return to main menu", True, (255, 255, 255))
    textRectObj = textSurfaceObj.get_rect()
    textRectObj.center = (pos - 150, pos - 620)#pos - 150, pos -50
    screen.blit(textSurfaceObj, textRectObj)
